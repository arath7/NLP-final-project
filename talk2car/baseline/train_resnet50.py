...
def main():
    ...
    params = list(text_encoder.parameters()) + list(img_encoder.parameters()) + list(img_projection.parameters())
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train(train_dataloader, img_encoder, text_encoder, img_projection, optimizer, criterion, epoch, args)
        ...
        save_checkpoint({'img_encoder': img_encoder.state_dict(),
                         ...
                         'img_projection': img_projection.state_dict(),
...
def train(train_dataloader, img_encoder, text_encoder, img_projection, optimizer, criterion, epoch, args):
    ...
    for i, batch in enumerate(train_dataloader):
        ...
        img_features = img_projection(img_features)
...
@torch.no_grad()
def evaluate(val_dataloader, img_encoder, text_encoder, img_projection, args):
    m_top1 = AverageMeter('Acc@1', ':6.2f')
    m_iou = AverageMeter('IoU', ':6.2f')
    m_ap50 = AverageMeter('AP50', ':6.2f')
